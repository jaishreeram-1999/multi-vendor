...
export default function TopNav() {
  const handleMenuToggle = () => {
    if (typeof window !== "undefined") {
      ...
      if (typeof customWindow.toggleMenuState === "function") {
  ...
  const handleMobileMenuToggle = () => {
    if (typeof window !== "undefined") {
      const customWindow = window as unknown as CustomWindowProps
      if (typeof customWindow.setIsMobileMenuOpen === "function") {
        const currentState = !!customWindow.isMobileMenuOpen
        customWindow.setIsMobileMenuOpen(!currentState)
      }
    }
  }
